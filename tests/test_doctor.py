if __name__ == "__main__":
    ...
    test_list = {
        ...
        "restart_firstframe": {
            ...
            "trj": f"{MOTHER_PATH}/src/files/cp2k/2022.2/errors/restart_first_frame_error/out-pos-1.pdb",
        },
        "restart_noisy": {
        ...
        "final_logframe": {
            "log": f"{MOTHER_PATH}/src/files/cp2k/2022.2/errors/log_less_error/out.log",
            "trj": f"{MOTHER_PATH}/src/files/cp2k/2022.2/errors/log_less_error/out-pos-1.xyz",
        },
    }
    ...
    for name, val in test_list.items():
        ...
        alchemist = cpb.Alchemist(val["log"], val["trj"])
        print(f"=" * 60)
